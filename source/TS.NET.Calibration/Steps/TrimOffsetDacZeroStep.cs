...
{
    public TrimOffsetDacZeroStep(string name, int channelIndex, int pathIndex) : base(name)
    {
        Action = (CancellationToken cancellationToken) =>
        {
            ...
            {
                Instruments.Instance.SetThunderscopeCalManual50R(channelIndex, pathCalibration.TrimOffsetDacZero, pathCalibration.TrimScaleDac, pathCalibration.PgaPreampGain, pathCalibration.PgaLadderAttenuator);
