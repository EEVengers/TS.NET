...
public class SelfCalibrationSequence : Sequence
{
    ...
    private void AddSteps(ModalUiContext modalUiContext)
    {
        ...
        [
            ...
            new TrimOffsetDacGainStep("Channel 1 - Trim offset DAC scale - HG L0", 0, PgaPreampGain.High, 0, Variables) { IgnoreError = true, Timeout = TimeSpan.FromSeconds(30), MaxRetries = 5 },
            new TrimOffsetDacGainStep("Channel 1 - Trim offset DAC scale - HG L1", 0, PgaPreampGain.High, 1, Variables) { IgnoreError = true, Timeout = TimeSpan.FromSeconds(30), MaxRetries = 5 },
            new TrimOffsetDacGainStep("Channel 1 - Trim offset DAC scale - HG L2", 0, PgaPreampGain.High, 2, Variables) { IgnoreError = true, Timeout = TimeSpan.FromSeconds(30), MaxRetries = 5 },
            ...
            new TrimOffsetDacGainStep("Channel 2 - Trim offset DAC scale - HG L0", 1, PgaPreampGain.High, 0, Variables) { IgnoreError = true, Timeout = TimeSpan.FromSeconds(30), MaxRetries = 5 },
            new TrimOffsetDacGainStep("Channel 2 - Trim offset DAC scale - HG L1", 1, PgaPreampGain.High, 1, Variables) { IgnoreError = true, Timeout = TimeSpan.FromSeconds(30), MaxRetries = 5 },
            new TrimOffsetDacGainStep("Channel 2 - Trim offset DAC scale - HG L2", 1, PgaPreampGain.High, 2, Variables) { IgnoreError = true, Timeout = TimeSpan.FromSeconds(30), MaxRetries = 5 },
            ...
            new TrimOffsetDacGainStep("Channel 3 - Trim offset DAC scale - HG L0", 2, PgaPreampGain.High, 0, Variables) { IgnoreError = true, Timeout = TimeSpan.FromSeconds(30), MaxRetries = 5 },
            new TrimOffsetDacGainStep("Channel 3 - Trim offset DAC scale - HG L1", 2, PgaPreampGain.High, 1, Variables) { IgnoreError = true, Timeout = TimeSpan.FromSeconds(30), MaxRetries = 5 },
            new TrimOffsetDacGainStep("Channel 3 - Trim offset DAC scale - HG L2", 2, PgaPreampGain.High, 2, Variables) { IgnoreError = true, Timeout = TimeSpan.FromSeconds(30), MaxRetries = 5 },
            ...
            new TrimOffsetDacGainStep("Channel 4 - Trim offset DAC scale - HG L0", 3, PgaPreampGain.High, 0, Variables) { IgnoreError = true, Timeout = TimeSpan.FromSeconds(30), MaxRetries = 5 },
            new TrimOffsetDacGainStep("Channel 4 - Trim offset DAC scale - HG L1", 3, PgaPreampGain.High, 1, Variables) { IgnoreError = true, Timeout = TimeSpan.FromSeconds(30), MaxRetries = 5 },
            new TrimOffsetDacGainStep("Channel 4 - Trim offset DAC scale - HG L2", 3, PgaPreampGain.High, 2, Variables) { IgnoreError = true, Timeout = TimeSpan.FromSeconds(30), MaxRetries = 5 },
