...
public class NoiseVerificationSequence : Sequence
{
    ...
    private void AddSteps(Func<Dialog, DialogResult> uiDialog)
    {
        ...
        [
            ...
            new AcRmsStep("Channel 1 - AC RMS - 50R, 8-bit, 1 GSPS, BW 100M, PGA HG L0", 0, 0, ThunderscopeTermination.FiftyOhm, ThunderscopeBandwidth.Bw100M, 1_000_000_000, Variables){ MinLimit = 0.00003, MaxLimit = 0.00009 },
            ...
            new AcRmsStep("Channel 1 - AC RMS - 50R, 8-bit, 1 GSPS, BW 350M, PGA HG L0", 0, 0, ThunderscopeTermination.FiftyOhm, ThunderscopeBandwidth.Bw350M, 1_000_000_000, Variables){ MinLimit = 0.00003, MaxLimit = 0.00009 },
            ...
            new AcRmsStep("Channel 1 - AC RMS - 50R, 8-bit, 1 GSPS, BW FULL, PGA HG L0", 0, 0, ThunderscopeTermination.FiftyOhm, ThunderscopeBandwidth.BwFull, 1_000_000_000, Variables){ MinLimit = 0.00003, MaxLimit = 0.00009 },
            ...
            new AcRmsStep("Channel 2 - AC RMS - 50R, 8-bit, 1 GSPS, BW 100M, PGA HG L0", 1, 0, ThunderscopeTermination.FiftyOhm, ThunderscopeBandwidth.Bw100M, 1_000_000_000, Variables){ MinLimit = 0.00003, MaxLimit = 0.00009 },
            ...
            new AcRmsStep("Channel 2 - AC RMS - 50R, 8-bit, 1 GSPS, BW 350M, PGA HG L0", 1, 0, ThunderscopeTermination.FiftyOhm, ThunderscopeBandwidth.Bw350M, 1_000_000_000, Variables){ MinLimit = 0.00003, MaxLimit = 0.00009 },
            ...
            new AcRmsStep("Channel 2 - AC RMS - 50R, 8-bit, 1 GSPS, BW FULL, PGA HG L0", 1, 0, ThunderscopeTermination.FiftyOhm, ThunderscopeBandwidth.BwFull, 1_000_000_000, Variables){ MinLimit = 0.00003, MaxLimit = 0.00009 },
            ...
            new AcRmsStep("Channel 3 - AC RMS - 50R, 8-bit, 1 GSPS, BW 100M, PGA HG L0", 2, 0, ThunderscopeTermination.FiftyOhm, ThunderscopeBandwidth.Bw100M, 1_000_000_000, Variables){ MinLimit = 0.00003, MaxLimit = 0.00009 },
            ...
            new AcRmsStep("Channel 3 - AC RMS - 50R, 8-bit, 1 GSPS, BW 350M, PGA HG L0", 2, 0, ThunderscopeTermination.FiftyOhm, ThunderscopeBandwidth.Bw350M, 1_000_000_000, Variables){ MinLimit = 0.00003, MaxLimit = 0.00009 },
            ...
            new AcRmsStep("Channel 3 - AC RMS - 50R, 8-bit, 1 GSPS, BW FULL, PGA HG L0", 2, 0, ThunderscopeTermination.FiftyOhm, ThunderscopeBandwidth.BwFull, 1_000_000_000, Variables){ MinLimit = 0.00003, MaxLimit = 0.00009 },
            ...
            new AcRmsStep("Channel 4 - AC RMS - 50R, 8-bit, 1 GSPS, BW 100M, PGA HG L0", 3, 0, ThunderscopeTermination.FiftyOhm, ThunderscopeBandwidth.Bw100M, 1_000_000_000, Variables){ MinLimit = 0.00003, MaxLimit = 0.00009 },
            ...
            new AcRmsStep("Channel 4 - AC RMS - 50R, 8-bit, 1 GSPS, BW 350M, PGA HG L0", 3, 0, ThunderscopeTermination.FiftyOhm, ThunderscopeBandwidth.Bw350M, 1_000_000_000, Variables){ MinLimit = 0.00003, MaxLimit = 0.00009 },
            ...
            new AcRmsStep("Channel 4 - AC RMS - 50R, 8-bit, 1 GSPS, BW FULL, PGA HG L0", 3, 0, ThunderscopeTermination.FiftyOhm, ThunderscopeBandwidth.BwFull, 1_000_000_000, Variables){ MinLimit = 0.00003, MaxLimit = 0.00009 },
