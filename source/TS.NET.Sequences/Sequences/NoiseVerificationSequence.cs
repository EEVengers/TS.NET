...
public class NoiseVerificationSequence : Sequence
{
    ...
    private void AddSteps(ModalUiContext modalUiContext)
    {
        ...
        [
            ...
            new AcRmsStep("Channel 1 - AC RMS", 0, 1_000_000_000, Variables){ MinLimit = 0.00003, MaxLimit = 0.00009 },
            new AcRmsStep("Channel 2 - AC RMS", 1, 1_000_000_000, Variables){ MinLimit = 0.00003, MaxLimit = 0.00009 },
            new AcRmsStep("Channel 3 - AC RMS", 2, 1_000_000_000, Variables){ MinLimit = 0.00003, MaxLimit = 0.00009 },
            new AcRmsStep("Channel 4 - AC RMS", 3, 1_000_000_000, Variables){ MinLimit = 0.00003, MaxLimit = 0.00009 },
