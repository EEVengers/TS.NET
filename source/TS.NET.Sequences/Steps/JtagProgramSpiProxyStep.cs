...
public class JtagProgramSpiProxyStep : Step
{
    public JtagProgramSpiProxyStep(string name, FactoryBringUpVariables variables) : base(name)
    {
        Action = (CancellationToken cancellationToken) =>
        {
            ...
            jtag.ProgramSpiProxy(0, cancellationToken);
