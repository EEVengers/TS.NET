...
namespace TS.NET.Benchmark
{
    ...
    public class SumU8toI32Benchmark
    {
        ...
        {
            for (int i = 0; i < 125; i++)
                Sum.U8ToI32(input.Span, bufferI16.Span, bufferI32.Span, 1);
        }
        ...
        {
            for (int i = 0; i < 125; i++)
                Sum.U8ToI32(input.Span, bufferI16.Span, bufferI32.Span, 2);
        }
        ...
        {
            for (int i = 0; i < 125; i++)
                Sum.U8ToI32(input.Span, bufferI16.Span, bufferI32.Span, 3);
        }
