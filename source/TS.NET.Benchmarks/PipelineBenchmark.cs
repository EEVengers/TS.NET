...
namespace TS.NET.Benchmark
{
    ...
    public class PipelineBenchmark
    {
        ...
        private readonly RisingEdgeTriggerI8 trigger1 = new();
        private readonly RisingEdgeTriggerI8 trigger2 = new();
        private readonly RisingEdgeTriggerI8 trigger3 = new();
        private readonly RisingEdgeTriggerI8 trigger4 = new();
