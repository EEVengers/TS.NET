...
namespace TS.NET.Benchmarks
{
    public unsafe class FallingEdgeTriggerI8Benchmark
    {
        ...
        private readonly FallingEdgeTriggerI8 trigger = new(new TriggerChannelParameters(1_000_000_000, 1, 0), new EdgeTriggerParameters() { LevelV = 0, HysteresisPercent = 5, Direction = EdgeDirection.Falling });
