...
namespace TS.NET.Benchmarks
{
    public unsafe class RisingEdgeTriggerI8Benchmark
    {
        ...
        private readonly RisingEdgeTriggerI8 trigger = new(new TriggerChannelParameters(1_000_000_000, 1, 0), new EdgeTriggerParameters() { LevelV = 0, HysteresisPercent = 5, Direction = EdgeDirection.Rising });
