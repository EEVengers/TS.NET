    ...
    public class ThunderscopeChannelCalibrationSettings
    {
        ...
        public static ThunderscopeChannelCalibrationSettings Default()
        {
            return new ThunderscopeChannelCalibrationSettings()
            {
                Paths =
                [
                    new(){ PgaLadderAttenuator = 0, PgaInputVpp = 0.009, TrimScaleDac = 83, TrimOffsetDacGainV = 0.5, TrimOffsetDacZero = 2048 },
                    new(){ PgaLadderAttenuator = 1, PgaInputVpp = 0.012, TrimScaleDac = 66, TrimOffsetDacGainV = 0.5, TrimOffsetDacZero = 2048 },
                    new(){ PgaLadderAttenuator = 2, PgaInputVpp = 0.016, TrimScaleDac = 53, TrimOffsetDacGainV = 0.5, TrimOffsetDacZero = 2048 },
                    new(){ PgaLadderAttenuator = 3, PgaInputVpp = 0.020, TrimScaleDac = 85, TrimOffsetDacGainV = 0.25, TrimOffsetDacZero = 2048 },
                    new(){ PgaLadderAttenuator = 4, PgaInputVpp = 0.025, TrimScaleDac = 67, TrimOffsetDacGainV = 0.25, TrimOffsetDacZero = 2048 },
                    new(){ PgaLadderAttenuator = 5, PgaInputVpp = 0.032, TrimScaleDac = 53, TrimOffsetDacGainV = 0.25, TrimOffsetDacZero = 2048 },
                    new(){ PgaLadderAttenuator = 6, PgaInputVpp = 0.040, TrimScaleDac = 42, TrimOffsetDacGainV = 0.25, TrimOffsetDacZero = 2048 },
                    new(){ PgaLadderAttenuator = 7, PgaInputVpp = 0.050, TrimScaleDac = 33, TrimOffsetDacGainV = 0.25, TrimOffsetDacZero = 2048 },
                    new(){ PgaLadderAttenuator = 8, PgaInputVpp = 0.062, TrimScaleDac = 26, TrimOffsetDacGainV = 0.25, TrimOffsetDacZero = 2048 },
                    new(){ PgaLadderAttenuator = 9, PgaInputVpp = 0.078, TrimScaleDac = 20, TrimOffsetDacGainV = 0.25, TrimOffsetDacZero = 2048 },
                    new(){ PgaLadderAttenuator = 10, PgaInputVpp = 0.098, TrimScaleDac = 16, TrimOffsetDacGainV = 0.25, TrimOffsetDacZero = 2048 },

                    new(){ PgaLadderAttenuator = 0, PgaInputVpp = 0.098, TrimScaleDac = 16, TrimOffsetDacGainV = 0.25, TrimOffsetDacZero = 2048 },
                    new(){ PgaLadderAttenuator = 1, PgaInputVpp = 0.124, TrimScaleDac = 12, TrimOffsetDacGainV = 0.25, TrimOffsetDacZero = 2048 },
                    new(){ PgaLadderAttenuator = 2, PgaInputVpp = 0.156, TrimScaleDac = 10, TrimOffsetDacGainV = 0.25, TrimOffsetDacZero = 2048 },
                    new(){ PgaLadderAttenuator = 3, PgaInputVpp = 0.196, TrimScaleDac = 8, TrimOffsetDacGainV = 0.25, TrimOffsetDacZero = 2048 },
                    new(){ PgaLadderAttenuator = 4, PgaInputVpp = 0.247, TrimScaleDac = 6, TrimOffsetDacGainV = 0.25, TrimOffsetDacZero = 2048 },
                    new(){ PgaLadderAttenuator = 5, PgaInputVpp = 0.310, TrimScaleDac = 4, TrimOffsetDacGainV = 0.25, TrimOffsetDacZero = 2048 },
                    new(){ PgaLadderAttenuator = 6, PgaInputVpp = 0.390, TrimScaleDac = 3, TrimOffsetDacGainV = 0.25, TrimOffsetDacZero = 2048 },
                    new(){ PgaLadderAttenuator = 7, PgaInputVpp = 0.491, TrimScaleDac = 2, TrimOffsetDacGainV = 0.25, TrimOffsetDacZero = 2048 },
                    new(){ PgaLadderAttenuator = 8, PgaInputVpp = 0.618, TrimScaleDac = 2, TrimOffsetDacGainV = 0.25, TrimOffsetDacZero = 2048 },
                    new(){ PgaLadderAttenuator = 9, PgaInputVpp = 0.777, TrimScaleDac = 1, TrimOffsetDacGainV = 0.25, TrimOffsetDacZero = 2048 },
                    new(){ PgaLadderAttenuator = 10, PgaInputVpp = 0.977, TrimScaleDac = 1, TrimOffsetDacGainV = 0.25, TrimOffsetDacZero = 2048 },
                ],
