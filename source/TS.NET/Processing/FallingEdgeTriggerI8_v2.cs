...
public class FallingEdgeTriggerI8_v2
{
    ...
    public FallingEdgeTriggerI8_v2(sbyte triggerLevel, ushort triggerHysteresis, ulong windowWidth, ulong windowTriggerPosition, ulong additionalHoldoff)
    {
