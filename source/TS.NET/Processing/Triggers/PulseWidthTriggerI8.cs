...
namespace TS.NET.Processing.Triggers
{
    public class PulseWidthTriggerI8
    {
        ...
        // condition: GE, GT, LE, LT, GELE, GTLT
        public void SetPulseCondition(bool pulseDirection, bool condition, double time1, double time2)
        {
