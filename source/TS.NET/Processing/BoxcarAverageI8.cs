...
public static class BoxcarAverageI8
{   
    ...
    public static Span<short> I8ToI16(ReadOnlySpan<sbyte> input, Span<short> buffer, byte iterations)
    {
    ...
    public static Span<int> I8ToI32(ReadOnlySpan<sbyte> input, Span<short> bufferI16, Span<int> bufferI32, byte iterations)
    {
        ...
        var i16Input = I8ToI16(input, bufferI16, iterationsI16);
